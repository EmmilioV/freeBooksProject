...
const ControlPanel = (props) => {
    ...
    return ( 
        <div className="control-panel m-3 p-3 d-flex align-items-baseline justify-content-between">
            <div className="d-flex justify-contet-between align-items-baseline">
                <i 
                ...
                />
                <span>
                    Page <input name="pageNumber" type="number" min={1} max={numPages || 1} className="p-0 pl-1 mx-2 text-center" value={pageNumber} onChange={onPageChange}/> of {numPages}
                </span>
                <i 
